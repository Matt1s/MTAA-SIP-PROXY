 ...
 # 1. zadanie - SIP Proxy - Matej Pakán
 Program spúšťam cez vlastný **main.py**
 Finálna dokumentácia sa nachádza v **Dokumentácia/SIP Proxy - Matej Pakán - Dokumentácia.pdf**
 Pri dokumentácii sú v priečinku **WireShark** Pribalené aj jednotlivé s scenáre s pomenovaním, aj screenshoty použité v dokumentácii.   


Pôvodné README.md ku knižnici PySipFullProxy je v odstavcoch nižšie
.
.
.
